  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Editar Usuário</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Nova Senha <span className="text-gray-400 font-normal">(deixe em branco para manter)</span></label>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-0 divide-y sm:divide-y-0 sm:divide-x-0">
                    {module.permissions.map((perm) => {
                      ...
                      return (
                        <label
                          key={perm.id}
                          className={`flex items-start gap-3 p-3 transition-colors ${canEdit ? 'cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/30' : 'cursor-default'}`}
                        >
                          <input
                            type="checkbox"
                            checked={checked}
                            onChange={() => canEdit && togglePermission(perm.id)}
                            disabled={!canEdit}
